...
import { escapeHtml } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/@vue/shared/dist/shared.cjs.js';
import { spawn } from 'node:child_process';
import { promises, existsSync } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import unstorage_47drivers_47fs from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/nie/Claude/papers/scholaraio/scholaraio/web/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/nie/Claude/papers/scholaraio/scholaraio/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/nie/Claude/papers/scholaraio/scholaraio/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/nie/Claude/papers/scholaraio/scholaraio/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/nie/Claude/papers/scholaraio/scholaraio/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/nie/Claude/papers/scholaraio/scholaraio/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/nie/Claude/papers/scholaraio/scholaraio/web/.data/kv"}));
...
const _fXi3zQEXt3321oUUvvZK2JA88oD_TkTZfiTjuU8gEEI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/nie/Claude/papers/scholaraio/scholaraio/web";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"ScholarAIO - Academic Paper Management"}],"link":[{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/katex@0.16.10/dist/katex.min.css"}],"style":[],"script":[],"noscript":[],"title":"ScholarAIO"};
...
const _1N2bhpAdq82b9NDAyQZYd3S5dd9DoB5UuLdx8W7n7rM = (nitroApp) => {
...
const _UH9jxR = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/nie/Claude/papers/scholaraio/scholaraio/web/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/nie/Claude/papers/scholaraio/scholaraio/web/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _lazy_n9ZEfx = () => Promise.resolve().then(function () { return _name__get$1; });
const _lazy_bp11Ut = () => Promise.resolve().then(function () { return roadmap_post$1; });
const _lazy_FnmkLu = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_k6crhK = () => Promise.resolve().then(function () { return graph_get$1; });
const _lazy_YY1OL9 = () => Promise.resolve().then(function () { return build_post$1; });
const _lazy_EBksam = () => Promise.resolve().then(function () { return knowledge_get$1; });
const _lazy_vYaSo7 = () => Promise.resolve().then(function () { return knowledge_post$1; });
...
const _lazy_25YFpB = () => Promise.resolve().then(function () { return tags_post$1; });
const _lazy_YJihe0 = () => Promise.resolve().then(function () { return generateBatch_post$1; });
const _lazy_XNGyY1 = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_XcghuH = () => Promise.resolve().then(function () { return projects_get$1; });
const _lazy_WEGepa = () => Promise.resolve().then(function () { return tags_get$1; });
const _lazy_mGlQFT = () => Promise.resolve().then(function () { return _taskId__get$1; });
const _lazy_CjDm82 = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _UH9jxR, lazy: false, middleware: true, method: undefined },
  { route: '/api/explore/:name', handler: _lazy_n9ZEfx, lazy: true, middleware: false, method: "get" },
  { route: '/api/explore/:name/roadmap', handler: _lazy_bp11Ut, lazy: true, middleware: false, method: "post" },
  { route: '/api/explore', handler: _lazy_FnmkLu, lazy: true, middleware: false, method: "get" },
  { route: '/api/graph', handler: _lazy_k6crhK, lazy: true, middleware: false, method: "get" },
  { route: '/api/graph/build', handler: _lazy_YY1OL9, lazy: true, middleware: false, method: "post" },
  { route: '/api/knowledge', handler: _lazy_EBksam, lazy: true, middleware: false, method: "get" },
  { route: '/api/knowledge', handler: _lazy_vYaSo7, lazy: true, middleware: false, method: "post" },
  ...
  { route: '/api/papers/:id/tags', handler: _lazy_25YFpB, lazy: true, middleware: false, method: "post" },
  { route: '/api/papers/generate-batch', handler: _lazy_YJihe0, lazy: true, middleware: false, method: "post" },
  { route: '/api/papers', handler: _lazy_XNGyY1, lazy: true, middleware: false, method: "get" },
  { route: '/api/projects', handler: _lazy_XcghuH, lazy: true, middleware: false, method: "get" },
  { route: '/api/tags', handler: _lazy_WEGepa, lazy: true, middleware: false, method: "get" },
  { route: '/api/tasks/:taskId', handler: _lazy_mGlQFT, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_CjDm82, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CjDm82, lazy: true, middleware: false, method: undefined }
];
...
const currentDir = path.dirname(fileURLToPath(globalThis._importMeta_.url));
...
async function callScholarBridge(action, payload = {}) {
...
const roadmap_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: roadmap_post
}, Symbol.toStringTag, { value: 'Module' }));
...
function parseIntParam$1(value, fallback) {
...
const graph_get = defineEventHandler(async (event) => {
  try {
    ...
    return await callScholarBridge("get_graph", {
      ...
      min_shared: parseIntParam$1(query.min_shared, 2),
      max_nodes: parseIntParam$1(query.max_nodes, 80)
    });
  } catch (error) {
    throw createError({
      statusCode: error.statusCode || 500,
...
const graph_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: graph_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const knowledge_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: knowledge_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const knowledge_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: knowledge_post
}, Symbol.toStringTag, { value: 'Module' }));

const fromPaper_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  try {
...
const fromPaper_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: fromPaper_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const generateBatch_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: generateBatch_post
}, Symbol.toStringTag, { value: 'Module' }));
